//
//  TodayInsertMenViewController.swift
//  Project2
//
...
class TodayInsertMenViewController: UIViewController,UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func saveFavorite(_ sender: UIBarButtonItem) {
        ...
        let myUrl = URL(string: "http://condi.swu.ac.kr/student/T05iphone/today/upload.php");
        ...
        let urlString: String = "http://condi.swu.ac.kr/student/T05iphone/today/insertFavorite.php"
