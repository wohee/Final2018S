...
class MenDetailViewController: UIViewController {
    ...
    @IBAction func buttonDelete() {
        ...
        alert.addAction(UIAlertAction(title: "Delete", style: .cancel, handler: { action in
            let urlString: String = "http://condi.swu.ac.kr/student/T05iphone/today/deleteFavorite.php"
    ...
    override func viewDidLoad() {
        ...
        if (imageName != "") {
            let urlString = "http://condi.swu.ac.kr/student/T05iphone/today"
