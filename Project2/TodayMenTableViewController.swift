//
//  TodayMenTableViewController.swift
//  Project2
//
...
class TodayMenTableViewController: UITableViewController {
    ...
    func downloadDataFromServer() -> Void {
        let urlString: String = "http://condi.swu.ac.kr/student/T05iphone/today/favoriteTable.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Men Exercise", for: indexPath)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailView" {
            if let destination = segue.destination as? MenDetailViewController {
